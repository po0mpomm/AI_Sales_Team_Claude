...
```bash
curl -fsSL https://raw.githubusercontent.com/anvaya-arsha/ai-sales-team-claude/main/install.sh | bash
```

### Manual Install

```bash
git clone https://github.com/anvaya-arsha/ai-sales-team-claude.git
...
# Or remotely
curl -fsSL https://raw.githubusercontent.com/anvaya-arsha/ai-sales-team-claude/main/uninstall.sh | bash
```
